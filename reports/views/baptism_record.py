...
from reports.forms import BaptismRecordForm
import requests
import base64
        ...
        if form.is_valid():
            ...
            pdf_data = {
                ...
                "content": [
                    {
                        "type": "addBg",
                        "path": "https://print.rexmi.in/img/infant_bap.png",
                        "opa": 1.0
                    },
                    {
                        "type": "writebook",
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if action == 'download':
                        ...
                        response['Content-Disposition'] = f'inline; filename="baptism_record_{data["record_number"]}.pdf"'
